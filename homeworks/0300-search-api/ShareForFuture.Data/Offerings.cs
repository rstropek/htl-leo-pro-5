...
public class OfferingSummaryEntityTypeConfiguration : IEntityTypeConfiguration<OfferingSummary>
{
    public void Configure(EntityTypeBuilder<OfferingSummary> builder)
    {
        builder.HasNoKey();
    }
}
